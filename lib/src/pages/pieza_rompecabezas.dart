...
class PiezaRompecabezas extends StatefulWidget {
  ...
  @override
  PiezaRompecabezasState createState() {
    return new PiezaRompecabezasState();
  }
}

class PiezaRompecabezasState extends State<PiezaRompecabezas> {
  double top;
  double left;
  ...
  Widget build(BuildContext context) {
    ...
    if (top == null) {
      top = Random().nextInt((imageHeight - pieceHeight).floor()).toDouble();
      top -= widget.row * pieceHeight;
    }
    if (left == null) {
      left = Random().nextInt((imageWidth - pieceWidth).floor()).toDouble();
